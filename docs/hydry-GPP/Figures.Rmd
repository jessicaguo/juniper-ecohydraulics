...
```{r fig-env, echo=FALSE, out.width="100%", fig.cap="<b>Fig. 1</b> Daily site-level environmental characteristics of <b>a)</b> vapor pressure deficit (D) and precipitation and <b>b)</b> volumetric water content (VWC) at two depths in 2021. Gray box indicates period of psychrometer instrumentation"}
