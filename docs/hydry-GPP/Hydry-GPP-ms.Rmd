...
-   *J. osteosperma* experiences weaker hydraulic regulation (i.e., anisohydry) and higher productivity after monsoon precipitation pulses, when soil moisture and atmospheric demand are high.
    The slope between $\Psi_{PD}$ and $\Psi_{MD}$ ($\sigma$), a common metric to quantify iso/anisohydry, is strongly correlated with GPP, although only during the monsoon period.
...
In this study, we set out to resolve knowledge gaps in our understanding of temporal variablity in plant hydraulic regulation and its relationship to ecosystem C fluxes.
...
Suprisingly, although both $\Psi_{MD}$ and $\Psi_{PD}$ responded rapidly to precipitation inputs, plants achieved maximum $\sigma$ 2-5 days after peak GPP was reached after a given moisture pulse.
...
to extract soil water even at low soil water potentials [@west2007] is consistent with extreme anisohydry and may serve to prolong elevated GPP in drying soils.
...
Hydraulic regulation strategies may also be linked to temporal dynamics of foliar ABA and rooting dynamics during soil water stress [@brodribb2013; @peek2006]. In *Callatris rhomboidea*, sustained water stress led to a decline in ABA such that loss of water potential (and thus guard cell turgor) drove stomatal closure, but conversely, low ABA also enabled rapid recovery after rewatering [@brodribb2013]. Among *Cupressaceae*, including *Juniperus* and *Callatris*, the use of leaf desiccation to close stomata during water stress could explain how *J. osteosperma* is able to both tolerate dry periods and respond rapidly to rewetting events. Temporal variability in hydraulic regulation may also be associated with timing of fine root production. In *J. osteosperma*, fine roots develop when soil water is most available and shift toward deeper layers as the growing season progresses [@peek2006], and root distributions may differ depending on cool-season vs. warm-season precipitation. Rooting dynamics can directly influence plant water potential via rhizosphere conductance, but this is difficult to measure empirically and often treated as a tuning parameter in models [@bristow1984; @sperry2016].

#### Implications for vegetation modeling

Plant hydraulic schemes are becoming increasingly represented in land surface models [@eller2020; @kennedy2019a; @sabot2020]. The link we observed between hydraulic strategy and GPP hints at the promise of these approaches for better predicting GPP, especially in dryland ecosystems where patchy resource availability leads to a widespread underpredictions of both the magnitude and variability of carbon fluxes [@macbean2021a; @barnes2021].
...
One avenue of model development operationalizes the trade-off between carbon gain and hydraulic costs at both short (daily) and intermediate (weekly) timescales, which allows for acclimation of plant processes to a changing environment [@joshi2022].
However, more research regarding when, where, and why temporally-varying water-use strategies arise is necessary to refine and test their necessity for improved modeling of dryland carbon fluxes.
Promisingly, a recent modeling exercise suggested that temporally-variable water-use strategies need not be directly included in models, and instead may be an emergent property of a new class of plant hydraulic models that optimize for the balance of carbon gain to hydraulic risk [@kannenberg2022a].

#### Conclusions

Though a classically considered anisohydric, *J. osteosperma* exhibited multiple hydraulic regulation strategies during the course of a growing season.
Extreme anisohydry was only exhibited after monsoon precipitation pulses, as soils were rapidly drying.
...
<!--# Evaluating plant responses at intermediate timescales can reveal the dual importance of biotic and physical regulation of ecosystem fluxes. -->
