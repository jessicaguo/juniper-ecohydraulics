...
To specify the hydraulic regulation model, we used the Martinez-Vilalta et al. [-@mart�nez-vilalta2014] equation to relate $\Psi_{MD}$ to $\Psi_{PD}$:
...
Antecedent variables [@ogle2015] were constructed using daily time series of each scale environmental variable:
