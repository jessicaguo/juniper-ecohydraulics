...
sm <- summary(m1) # R2 = 0.1212, slope = 0.1222
...
figS3 <- plot_grid(figS3b, figS3c, figS3d,
                  nrow = 1,
                  labels = "auto",
                  rel_widths = c(1, 2.5, 1.75),
                  label_size = 12)

figS3

ggsave(filename = "scripts/model-gpp-nirv/figs/fig_S3.png",
       plot = figS3,
       width = 8, height = 2.75,
       units = "in")
