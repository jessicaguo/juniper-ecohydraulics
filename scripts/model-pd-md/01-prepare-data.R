...
# Identify each tree as a random effect
...
save(met_in, file = "scripts/model-pd-md/met_in.Rdata")
save(psy_in, file = "scripts/model-pd-md/psy_in.Rdata")
save(branch_in, file = "scripts/model-pd-md/branch_in.Rdata")
